        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12">
              <button onClick={() => scrollToSection('cta')} className="bg-gradient-to-r from-pink-400 to-purple-400 text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-xl hover:scale-105 transition-all duration-300">Đặt hàng</button>
              <button onClick={() => scrollToSection('products')} className="bg-white text-gray-800 px-8 py-4 rounded-full text-lg font-semibold border-2 border-gray-200 hover:border-pink-300 hover:shadow-lg transition-all duration-300">Xem bộ sưu tập</button>
            </div>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-pink-200 via-purple-200 to-blue-200 rounded-3xl h-[400px] sm:h-[500px] lg:h-[600px] flex items-center justify-center shadow-2xl overflow-hidden">
              <img src="/img/anh1.jpg" alt="Handmade bag" className="w-full h-full object-cover rounded-3xl" />
            </div>
